...
def _scope_for_path(path: str) -> tuple[str, int] | None:
    ...
    if path in {
        "/api/v1/repos/{repo}/upload/init",
        "/api/v1/repos/{repo}/upload/init/cab",
        "/api/v1/repos/{repo}/upload/stream/open",
        "/api/v1/repos/{repo}/download/stream/open",
        "/api/v1/repos/{repo}/download/cab",
    }:
