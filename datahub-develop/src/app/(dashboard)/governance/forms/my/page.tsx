...
import { boardSegment } from "@/components/governance/BoardListView";
import { BOARD_LABELS, FORM_TYPE_LABELS, formatDateTime, parseUtc } from "@/lib/governance/forms/utils-bridge";
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 text-left text-gray-500">
              <tr>
                ...
                <th className="w-44 px-6 py-3 font-medium">최종 수정일</th>
              </tr>
            </thead>
            <tbody>
              {pageItems === null ? (
