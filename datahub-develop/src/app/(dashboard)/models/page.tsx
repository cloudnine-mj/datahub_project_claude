  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-heading text-2xl font-bold text-text-primary">Models</h1>
          <p className="mt-1 text-sm text-text-secondary">내가 접근할 수 있는 모델 저장소 목록</p>
        </div>
        <Button
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center gap-4 rounded-xl border border-dh-border bg-white py-16 text-center">
          <Brain className="h-10 w-10 text-text-muted" />
          <div>
        ...
        <div className="rounded-xl border border-dh-border bg-white divide-y divide-dh-border overflow-hidden">
          {filtered.map((repo) => {
            ...
            return (
              ...
              >
                <Brain className="h-5 w-5 shrink-0 text-text-muted mt-0.5" />
