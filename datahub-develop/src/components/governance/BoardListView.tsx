      ...
      <div className={(compact ? "" : (isProcess ? "mt-6 " : "mt-8 ")) + "flex flex-wrap items-center gap-3"}>
        ...
        {isManage && (
          <div className="ml-auto">
            <Link
              href={`/governance/${boardSegment(board)}/new?manage=1`}
                ...
                return (
                  <tr key={p.id} className="border-t border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <Link href={`/governance/${boardSegment(board)}/${p.id}${isManage ? "?manage=1" : ""}`} className="inline-flex items-center gap-2 font-medium hover:text-brand">
                        {p.pinned && (
