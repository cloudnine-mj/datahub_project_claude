...
import { api, type BoardType, type Me, type PostVisibility, type Severity } from "@/lib/governance/api-client-full";
import { boardSegment } from "./BoardListView";
import { DOC_TYPES, PROCESS_CATEGORIES } from "@/lib/governance/forms/utils-bridge";
  ...
  async function save(asDraft: boolean) {
    ...
    try {
      ...
      if (asDraft || isEdit) {
        ...
        router.push(`/governance/${boardSegment(board)}${manageListQuery}`);
      }
    } catch (e) {
