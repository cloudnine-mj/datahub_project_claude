// 화면 5: 데이터 거버넌스 문서 서식 — 신청서 양식 카드 목록.
...
export default function FormsIndexPage() {
  return (
    <div>
      <Breadcrumb items={[{ label: "Governance", href: "/governance" }, { label: "데이터 거버넌스 문서 서식" }]} />
      <h1 className="text-3xl font-bold tracking-tight">데이터 거버넌스 문서 서식</h1>
