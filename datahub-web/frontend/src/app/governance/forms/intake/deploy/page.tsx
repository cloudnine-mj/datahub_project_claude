// 데이터 용역 제작 / 구매 / 구독 — 3. 적재 단계 (중앙 저장소 적재 · 데이터 카드).
...
export default function Page() {
  return (
    <div>
      ...
      />
      <h1 className="text-3xl font-bold tracking-tight">3. 적재</h1>
      ...
      <div className="mt-8 flex flex-col items-center justify-center rounded-lg border border-dashed border-gray-200 bg-gray-50/40 px-6 py-16 text-center">
        ...
        <p className="mt-1.5 max-w-md text-sm text-gray-500">
          Data Governance Team 이 지정한 위치에 적재 후 데이터 카드를 작성하는
          흐름입니다. DataHub 내 적재/카드 연동 자동화는 추후 추가될 예정입니다.
        </p>
        <Link
